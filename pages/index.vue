              ...
              <div class="row single-slide align-items-center d-flex">
                <div class="col-lg-5 col-md-6">
                  <div class="banner-content">
                    <h1>TROBOLO <br />WandaGO!</h1>
                    <p>
                      Die neue Campingtoilette <strong>WandaGO</strong> von
                      TROBOLO ist da! Bestelle dir die ultraleichte und kompakte
                      Campingtoilette vor und erhalte einen Rabatt von 50,00
                      EUR!
                    </p>
              ...
              <div class="row single-slide">
                ...
                <div class="col-lg-7">
                  <div class="banner-img">
                    <img
                      class="img-fluid"
                      src="/assets/images/img/banner/banner-img.png"
                      alt=""
                    />
                  </div>
                </div>
